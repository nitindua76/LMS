  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100vh", overflow: "hidden" }}>
      <header className="mobile-topbar">
        ...
        <span style={{ fontWeight: 700, fontSize: 15, color: "var(--sidebar-text)" }}>LMS Admin</span>
      </header>
      ...
      <div style={{ display: "flex", flex: 1, minHeight: 0, position: "relative" }}>
        <aside className={`sidebar${sidebarOpen ? " sidebar-open" : ""}${isCollapsed ? " collapsed" : ""}`}>
          <div style={{
            ...
            <div>
              <div style={{ fontWeight: 700, fontSize: 15, color: "var(--sidebar-text)", letterSpacing: "-0.01em" }}>LMS Admin</div>
              <div style={{ fontSize: 11, color: "var(--sidebar-text-muted)", marginTop: 2, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", maxWidth: 160 }} title={user?.email || ""}>
                {user?.email}
              </div>
            </div>
